...
/**
 * Servlet implementation class EjbCallingServlet
 */
@WebServlet("/EjbCallingServlet")
public class EjbCallingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.println("[Servlet] Hi, this is EjbCallingServlet.");
		writer.println("<p>");
		...
		writer.println("<p>");
		writer.println("[EJB] " + osgiBean.callOSGiService());
		writer.println("<p>");
